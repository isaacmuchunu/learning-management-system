      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-cyber-500/10 border border-cyber-500/30 mb-3">
            ...
            <span className="text-cyber-400 text-sm font-medium">Testimonials</span>
          </div>
          ...
          <p className="text-dark-400 text-base max-w-2xl mx-auto">
            Thousands of professionals have transformed their careers with our training.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-5">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <Quote className="absolute top-4 right-4 h-10 w-10 text-cyber-500/10" />
              ...
              <p className="text-dark-300 text-sm leading-relaxed mb-3 italic">
                &quot;{testimonial.quote}&quot;
              </p>
